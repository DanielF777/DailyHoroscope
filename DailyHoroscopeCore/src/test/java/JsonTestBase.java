...
class JsonTestBase {
    ...
    String primedJsonText() {
        return "\"dailyhoroscope\": {\n" +
                "    \"Aries\": \"You shouldn't be listening to gossip or spreading it yourself. It's fun when someone else is the subject, but what if you were that person?<a href=\\\"https://horoscopes-and-astrology.com/Aries\\\" alt=\\\"Aries\\\" target=\\\"_blank\\\"> <i>Read more...</i></a>\",\n" +
                "    \"Taurus\": \"Be careful not to cut corners or take the easy way out - even though it is tempting, it is not worth it in the long run.<a href=\\\"https://horoscopes-and-astrology.com/Taurus\\\" alt=\\\"Taurus\\\" target=\\\"_blank\\\"> <i>Read more...</i></a>\",\n" +
                "    \"Gemini\": \"You may catch yourself in the act of being suspicious of others and secretly ascribing hidden motives to their actions.<a href=\\\"https://horoscopes-and-astrology.com/Gemini\\\" alt=\\\"Gemini\\\" target=\\\"_blank\\\"> <i>Read more...</i></a>\",\n" +
                "}\n";
    }

    String horoscopesApiPayload() {
        return "{\n" +
                "  \"dailyhoroscope\": {\n" +
    ...
    Map<String, String> dailyhoroscope() {
